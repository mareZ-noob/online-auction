...
function UpdateCategory({className, category}: {className?: string, category: CATEGORY | CHILD_CATEGORY}) {
	...
	const handleOpenForm = (e: React.MouseEvent<HTMLButtonElement>, category: {  name: string; description: string; }) => {
		e.stopPropagation();
