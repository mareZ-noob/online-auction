	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
			...
			>
				...
				<ChildFigureCard title="New Users This Month" figure={data.newUsersThisMonth} />
			</FigureCard>
			<FigureCard
			...
			>
				<ChildFigureCard title="Active Products" figure={data.activeProducts} />
				<ChildFigureCard title="Completed Products" figure={data.completedProducts} />
				<ChildFigureCard title="New Products This Month" figure={data.newProductsThisMonth} />
			</FigureCard>
			<FigureCard
				title="Total Revenue"
			...
			>
				<ChildFigureCard title="Upgrade Requests Pending" figure={data.upgradeRequestsPending} />
			</FigureCard>
		</div>
	);
}
