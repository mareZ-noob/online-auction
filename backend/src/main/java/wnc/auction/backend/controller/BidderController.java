...
public class BidderController {
    ...
    public ResponseEntity<ApiResponse<List<BidHistoryDto>>> getBidHistory(
    ...
    public ResponseEntity<ApiResponse<PageResponse<TransactionDto>>> getMyPurchases(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "20") int size) {
        PageResponse<TransactionDto> transactions = transactionService
                .getMyPurchases(page, size);
    ...
    public ResponseEntity<ApiResponse<TransactionDto>> getTransactionByProduct(
            @PathVariable Long productId) {
    ...
    public ResponseEntity<ApiResponse<TransactionDto>> updateShippingAddress(
        ...
        TransactionDto transaction = transactionService
                .updateShippingAddress(transactionId, request);
    ...
    public ResponseEntity<ApiResponse<TransactionDto>> confirmPayment(
        ...
        TransactionDto transaction = transactionService
                .confirmPayment(transactionId, request);
    ...
    public ResponseEntity<ApiResponse<TransactionDto>> confirmDelivery(
            @PathVariable Long transactionId) {
    ...
    public ResponseEntity<ApiResponse<RatingDto>> rateUser(
    ...
    public ResponseEntity<ApiResponse<UpgradeRequestDto>> requestUpgrade(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                "Upgrade request submitted", upgradeRequest));
    }
    ...
    public ResponseEntity<ApiResponse<List<UpgradeRequestDto>>> getMyUpgradeRequests() {
        List<UpgradeRequestDto> requests = upgradeRequestService
