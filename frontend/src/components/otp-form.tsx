...
import { toastSuccess } from "./custom-ui/toast/toast-ui";
...
export function OTPForm({ ...props }: React.ComponentProps<typeof Card>) {
  ...
  const onSubmit = (values: OTPFormData) => {
    ...
    verifyEmailMutate(data, {
      onSuccess: () => {
        toastSuccess("Email Verified Successfully. Please Sign In.");
  ...
  const handleResendEmailCode = () => {
    ...
    resendVerificationMutate(data, {
      onSuccess: () => {
        toastSuccess("Resend Email Verification Successfully");
      },
    });
  };
